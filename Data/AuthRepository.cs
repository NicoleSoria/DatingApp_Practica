...
namespace DatingApp.API.Data
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public async Task<User> Loguin(string username, string password)
        {
            var user = await _context.Users.Include( p => p.Fotos).FirstOrDefaultAsync(x => x.Username == username);
